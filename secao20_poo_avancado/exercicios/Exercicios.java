...
public class Exercicios {
    ...
    public static void main(String[] args) {
        ...
        Endereco endereco = new Endereco("Padre Cícero", 120, "Remígio");

        Pessoa pessoa = new Pessoa("Maria", 60, endereco);
        ...
        Cachorro cachorro1 = new Cachorro("Nino", "Au au", "Pinscher");
        Cachorro cachorro2 = new Cachorro("Pantera", "Au au", "Rottweiler");
